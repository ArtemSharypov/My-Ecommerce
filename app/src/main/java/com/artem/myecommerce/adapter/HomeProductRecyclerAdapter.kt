...
class HomeProductRecyclerAdapter(var productItemsList: ArrayList<ProductItem>, var context: Context) : RecyclerView.Adapter<HomeProductRecyclerAdapter.ViewHolder>(){
